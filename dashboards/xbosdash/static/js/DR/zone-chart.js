...
$(document).ready(function() {
	...
	function pointFormatter() {
		...
		// console.log(parseInt(this.color));
		// console.log(this.color);
		...
		// console.log(s);
		return s;
		// return "<span style='color:" + parseInt(this.color) + "'>\u25CF</span>" + this.id.split(" ")[1] + ": " + this.y + "<br/>";
		// if ("state" in this) {
			// last 3 chars
		...
		// else { 
		// return "<span style='color:blue;'>\u25CF</span>" + this.id.split(" ")[1] + ": " + this.y + "<br/>";
		// }
    }
			...
			"events": {
				"load": function(e) {
					$.ajax({
                        ...
                        // Interchanged error and success
						"error": function(d) {
						    console.log("Error: ", d);
						},
						"success": function(d) {
